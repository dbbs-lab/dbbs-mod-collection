...
def package():
  ...
  #-##
  #-Generated by Astrocyte v0.2.3
  #-mod_glia__dbbs_mod_collection__NMDA__autistic
  mod_glia__dbbs_mod_collection__NMDA__autistic = Mod()
  mod_glia__dbbs_mod_collection__NMDA__autistic.pkg_name = 'dbbs_mod_collection'
  mod_glia__dbbs_mod_collection__NMDA__autistic.asset_name = 'NMDA'
  mod_glia__dbbs_mod_collection__NMDA__autistic.variant = 'autistic'
  mod_glia__dbbs_mod_collection__NMDA__autistic.namespace = 'glia__dbbs_mod_collection'
  mod_glia__dbbs_mod_collection__NMDA__autistic._is_point_process = True
  mod_glia__dbbs_mod_collection__NMDA__autistic._is_artificial_cell = False
  mod_glia__dbbs_mod_collection__NMDA__autistic._name_statement = 'POINT_PROCESS'
  mod_glia__dbbs_mod_collection__NMDA__autistic.pkg = pkg
  pkg.mods.append(mod_glia__dbbs_mod_collection__NMDA__autistic)
  #-##
  #-Generated by Astrocyte v0.2.3
  #-mod_glia__dbbs_mod_collection__AMPA__autistic
  mod_glia__dbbs_mod_collection__AMPA__autistic = Mod()
  mod_glia__dbbs_mod_collection__AMPA__autistic.pkg_name = 'dbbs_mod_collection'
  mod_glia__dbbs_mod_collection__AMPA__autistic.asset_name = 'AMPA'
  mod_glia__dbbs_mod_collection__AMPA__autistic.variant = 'autistic'
  mod_glia__dbbs_mod_collection__AMPA__autistic.namespace = 'glia__dbbs_mod_collection'
  mod_glia__dbbs_mod_collection__AMPA__autistic._is_point_process = True
  mod_glia__dbbs_mod_collection__AMPA__autistic._is_artificial_cell = False
  mod_glia__dbbs_mod_collection__AMPA__autistic._name_statement = 'POINT_PROCESS'
  mod_glia__dbbs_mod_collection__AMPA__autistic.pkg = pkg
  pkg.mods.append(mod_glia__dbbs_mod_collection__AMPA__autistic)
  #-##
  return pkg
